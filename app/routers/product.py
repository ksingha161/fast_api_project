...
def get_products(db: Session = Depends(get_db), user: int = Depends(oauth2.get_current_user)):
...
def get_product(id: int, db: Session = Depends(get_db), user: int = Depends(oauth2.get_current_user)):
...
def delete_product(id: int, db: Session = Depends(get_db), user: int = Depends(oauth2.get_current_user)):
